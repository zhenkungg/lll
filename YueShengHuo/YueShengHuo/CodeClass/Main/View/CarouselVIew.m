...
{
    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(_width-80, _height-20, 70, 30)];
...
{
    self.textLable = [[UILabel alloc] initWithFrame:CGRectMake(0, _height -25, _width-80 ,30 )];
    self.textLable.textColor = [UIColor orangeColor];
