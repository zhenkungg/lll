...
- (void)layoutSubviews{
    ...
    self.imageV.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height-30);
    self.imageV.layer.cornerRadius = 5;
    self.imageV.layer.masksToBounds = YES;
    
    self.lab.frame = CGRectMake(0, self.frame.size.width, self.frame.size.width, 20);
