//
//  OtherFindDetailViewController.m
//  Life
//
...
@interface OtherFindDetailViewController ()<UITableViewDataSource,UITableViewDelegate,KindDelegate>
...
@implementation OtherFindDetailViewController
...
- (void)initTableView{
    ...
    self.detailTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight-64) style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if(indexPath.section == 0){
        ...
        if([self.Array[indexPath.row] cType] == 0) {
            ...
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
            [cell.imageV sd_setImageWithURL:[NSURL URLWithString:[self.Array[indexPath.row] img] [@"originUrl"]] placeholderImage:[UIImage imageNamed:@"qqPit"]];
            return cell;
        }
