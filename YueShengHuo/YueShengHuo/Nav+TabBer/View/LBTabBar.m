...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"plus_Last"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"plus_Last"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    self.plusBtn.size = CGSizeMake(self.plusBtn.currentBackgroundImage.size.width, self.plusBtn.currentBackgroundImage.size.height);
        ...
        label.centerY = CGRectGetMaxY(self.plusBtn.frame) + LBMagin  - 5;
